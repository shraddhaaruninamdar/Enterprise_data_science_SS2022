...
# %load ../ads_covid-19/src/data/get_data.py
...
# %load ../ads_covid-19/src/data/process_JH_data.py
import pandas as pd
import numpy as np
...
def store_relational_JH_data():
    ...
    pd_relational_model.to_csv('../ads_covid-19/data/processed/COVID_relational_confirmed.csv',sep=';',index=False)
